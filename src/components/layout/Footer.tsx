        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-20">
          ...
          <div className="md:col-span-2 flex flex-col items-start gap-6">
            ...
            <div className="flex items-center gap-5">
              <a href={INSTAGRAM_URL} target="_blank" rel="noopener noreferrer" className="text-foreground/40 hover:text-[#ffb690] transition-all duration-500">
                <InstagramIcon />
              </a>
              <a href={FACEBOOK_URL} target="_blank" rel="noopener noreferrer" className="text-foreground/40 hover:text-[#ffb690] transition-all duration-500">
                <FacebookIcon />
              </a>
              <a href={LINKEDIN_URL} target="_blank" rel="noopener noreferrer" className="text-foreground/40 hover:text-[#ffb690] transition-all duration-500">
                <LinkedInIcon />
              </a>
              <a href={WHATSAPP_CTA_URL} target="_blank" rel="noopener noreferrer" className="text-foreground/40 hover:text-[#ffb690] transition-all duration-500">
                <WhatsAppIcon />
              </a>
            </div>
          </div>
