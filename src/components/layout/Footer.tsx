...
export function Footer() {
  ...
  return (
    <footer className="bg-surface-lowest border-t border-white/8 pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div className="flex flex-col gap-4">
            <Image
              ...
              height={32}
            />
            <p className="font-body text-sm text-foreground/50 leading-relaxed max-w-[240px]">
              Software Factory en Córdoba, Argentina. Construimos el digital que tu negocio merece.
            </p>
        ...
        <div className="border-t border-white/8 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-1 bg-black/40 rounded-full px-3 py-1.5 border border-white/8">
            <Image
